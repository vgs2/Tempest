...
SELECT product_name, SUM(amount) as total FROM aux_view2 GROUP BY product_name order by total desc limit 5
...
SELECT * FROM cost_purchase INNER JOIN adresses on adresses.adresses_id = cost_purchase.adresses_id